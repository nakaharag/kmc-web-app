    ...
    <div class="container">
      <div class="col-8 offset-2">
          <div class="card card-default">
              <div class="card-header">Cadastrar Seguidores</div>
              ...
              <div class="row p-3" v-on:click="forceRerender">
                <div class="col-12">
                  <addClientFollowers :empresaId="empresa.id" componentKey></addClientFollowers>       
                </div>
              </div>
          </div>
      </div>
...
import addClientFollowers from '../../components/add-client-followers.vue'
